...
<head>
    ...
    <title>Muslim Day Dashboard</title>
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class=" py-2 collapse-inner rounded" style="background: #4167D5">
                        ...
                        <a class="collapse-item text-light" href="{{ route('dua_category.index') }}"> <i
                                class="fa-solid fa-list"></i> Category Lists</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ asset('backend_assets') }}/#" data-toggle="modal"
